...
import AdminManagementPage from "./AdminManagementPage.jsx"; // ✅ ADDED
...
function LogoutButton() {
  ...
  const handleLogout = () => {
    if (window.confirm("Are you sure you want to logout?")) {
      ...
      localStorage.removeItem("isAdmin"); // ✅ ADDED - Clear admin status on logout
      setIsLoggedIn(false);
...
// ✅ ADDED - Admin Access Button (appears when logged in)
...
// ✅ ADDED - Protected Route Component for Admin
